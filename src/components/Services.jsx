      ...
      >
        ...
        <div className="relative z-20 min-h-screen flex items-center text-center md:text-left">
          <div className="w-full max-w-3xl px-6 sm:px-10 lg:px-20 md:mt-0">
            ...
            <h1 className="mt-4 text-4xl sm:text-5xl lg:text-6xl font-semibold text-blue-900 leading-tight">
              Professional Dry
              <br />
              Cleaning
            </h1>

            <p className="mt-6 text-sm sm:text-base md:text-lg text-gray-200 leading-5 max-w-xl">
