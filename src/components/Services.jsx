...
import { CircleCheck, Star, Minus, MoveRight, Clock3, Leaf , Truck, ShieldCheck, Play} from 'lucide-react';
      ...
      >
        ...
        <div className="relative z-20 min-h-screen flex items-center text-center md:text-left">
          <div className="w-full max-w-3xl px-6 sm:px-10 lg:px-20 md:mt-0">
            ...
            <h1 className="mt-4 text-4xl sm:text-5xl lg:text-6xl font-bold text-blue-900 leading-tight">
              Professional Dry
              <br />
              Cleaning
            </h1>

            <p className="mt-6 text-sm sm:text-base md:text-lg text-gray-800 leading-5 max-w-xl">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-16 pt-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <p className="text-gray-600 text-base md:text-lg mt-4  leading-6">
          ...
          <div className="space-y-6">
            <img
              src={Ironing}
              alt="Ironing"
              className="h-60 md:h-72 w-full rounded-2xl object-contain shadow-2xl"
            />
            <div className="border border-gray-300 rounded-2xl p-6 md:p-8 bg-gray-100">
              <Clock3 className="text-blue-900 mb-4" size={28} />
          ...
          {/* RIGHT SECTION */}
          <div className="space-y-6">
            <div className="bg-teal-800 text-white p-6 md:p-8 rounded-2xl shadow-xl">
              <Leaf size={28} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {price.map((item) => (
              <div
                ...
                className="group w-full min-h-[350px] border border-gray-300 rounded-2xl p-6 bg-blue-50 text-start transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:border-blue-900"
              >
