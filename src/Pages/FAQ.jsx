...
// import { faqData } from "../Data/LaundaryData";
...
{serviceResult && (
  <div className="max-w-4xl mx-auto mt-8 bg-white border border-blue-100 rounded-2xl p-6 shadow-lg animate-pulse">
              ...
              {filteredFaqs.map((faq) => (
                ...
                >
                  ...
                  >
                    ...
                    <span className="font-semibold text-[#0f3d7a] text-left">
                      {faq.question}
                    </span>
